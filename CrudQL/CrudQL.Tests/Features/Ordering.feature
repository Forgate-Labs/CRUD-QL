Feature: GET Ordering
  ...
  Scenario: Order by multiple fields
    ...
    And I send a GET request to "/crud?entity=Product&orderBy=price:asc,name:desc&select=id,name,price"
    Then the response status code should be 200
  ...
  Scenario: Order with filter
    When I send a GET request to "/crud?entity=Product&orderBy=name:desc&filter=%7B%22field%22%3A%22price%22%2C%22op%22%3A%22gte%22%2C%22value%22%3A30%7D&select=id,name,price"
    Then the response status code should be 200
  ...
  Scenario: Order by field not allowed returns error
    ...
    When I create the following products through POST /crud
      ...
      | Product B  | Item B      | 20.00  | USD      |
      | Product D  | Item D      | 40.00  | USD      |
    And I send a GET request to "/crud?entity=Product&orderBy=name&select=id,name,price"
  ...
  Scenario: Order by allowed field succeeds
    ...
    When I create the following products through POST /crud
      ...
      | Product B  | Item B      | 20.00  | USD      |
      | Product D  | Item D      | 40.00  | USD      |
    And I send a GET request to "/crud?entity=Product&orderBy=price:desc&select=id,name,price"
    Then the response status code should be 200
    And the first product should have name "Product E"
  ...
  Scenario: Default ordering applied when not specified
    ...
    When I create the following products through POST /crud
      ...
      | Product B  | Item B      | 20.00  | USD      |
      | Product D  | Item D      | 40.00  | USD      |
    And I send a GET request to "/crud?entity=Product&select=id,name,price"
    Then the response status code should be 200
    And the first product should have name "Product E"
    And the product at position 5 should have name "Product A"
  ...
  Scenario: Explicit ordering overrides default
    ...
    When I create the following products through POST /crud
      ...
      | Product B  | Item B      | 20.00  | USD      |
      | Product D  | Item D      | 40.00  | USD      |
    And I send a GET request to "/crud?entity=Product&orderBy=name:asc&select=id,name,price"
    Then the response status code should be 200
    And the first product should have name "Product A"
